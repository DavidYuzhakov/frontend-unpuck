...
const SUBCATEGORIES = {
  ...
  office: ['supplies', 'furniture', 'technology', 'organization', 'presentation']
}
...
export function ProductEditModal({ product, onClose, onSave }: ProductEditModalProps) {
  ...
  const validateForm = () => {
    ...
    if (formData.originalPrice && parseFloat(formData.originalPrice) <= parseFloat(formData.price)) {
      newErrors.originalPrice = 'Оригинальная цена должна быть больше текущей цены'
    }
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-500">
                Можно добавить до 5 изображений. Первое изображение будет главным.
              </p>
            </div>
